...
![Totals Hits](https://komarev.com/ghpvc/?username=sofyan-aboelazm&style=flat&color=orange&label=PROFILE+VIEWS)
...
const sofyanAboelazm = {
  backEnd: ["PHP", "Laravel", "MySQL"],
  frontEnd: ["React", "JavaScript", "jQuery", "Bootstrap", "HTML5", "CSS3"],
